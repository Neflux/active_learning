...
class BCNN(BayesianNetworkModule):
    ...
    def __init__(self, in_channels, out_channels, samples=12):
...
scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, factor=0.5, patience=1, cooldown=1, threshold=0.05, verbose=True)
